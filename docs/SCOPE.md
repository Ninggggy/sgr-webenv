...
| Wateroffice | HYDAT 2026-07-17, 483 stations with thirty-day official observations/status, the remaining 1,765 with prior snapshots, station metadata, maps and downloads | Historical and realtime sources have separate dates. Map areas and observation fields are described in [the data guide](../environments/wateroffice/DIFFERENCES.md). |
