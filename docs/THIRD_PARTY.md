...
|---|---|---|
| arXiv descriptive metadata | [API terms](https://info.arxiv.org/help/api/tou.html), CC0 descriptive metadata | Bibliographic records and version timelines; no paper PDFs or source |
...
| Wateroffice hydrometric data | [Environment Canada disclaimer](https://wateroffice.ec.gc.ca/disclaimer_info_e.html) | Retain attribution and source warnings; do not resell bundled raw data |
...
ZingChart is user-supplied. Follow the [download and local-build guide](../environments/noaa/README.md). Its [Branded License](https://www.zingchart.com/pricing/branded-license) requires visible branding and excludes distribution in installable software products; that distribution requires applicable OEM permission.

Keep ZingChart and license keys out of public source history and Release attachments. Do not publish images containing it without the applicable permission. Obtaining the package for local use does not grant redistribution rights.
...
The runtime data derive from national NCHS public-use files. Preserve source attribution, statistical-use restrictions and small-cell protection rules. The code license does not relicense these data. See [source and use conditions](reviews/WONDER_DATA_REDISTRIBUTION.md).
...
Agency names and identity artwork identify the source websites; their inclusion does not grant trademark rights or imply endorsement.
