 ...
 def handle_request(self,post=False):
  ...
  try:
   ...
   if path in ['/coverage','/license','/outside','/api','/description.html','/contact','/sars-cov-2.html','/educational_resources.html','/overview_rii.html','/SAB.html','/references.html']:
    body='<p>Cellosaurus record search, downloads and CLASTR STR matching. Use the search form and result controls to browse, sort and export records.</p><p>Data: CALIPHO / SIB, CC BY 4.0. CLASTR code: GPL-3.0.</p>'
