        ...
        try {
            ...
            DefaultHandler handler = new DefaultHandler() {
                ...
                void flushText() {
                    ...
                    char[] chars = textBuffer.toString().toCharArray();
                    textBuffer.setLength(0);
                    consumeText(chars, 0, chars.length);
                }
                @Override
                ...
                public void startElement(String uri, String localName, String qName, Attributes attributes) {
                    ...
                    switch (qName) {
                        ...
                        case "marker-data":
                            ...
                            references.clear();
                            break;
                        case "alleles": // legacy release 29 fixtures
                        case "marker-alleles":
                            bAlleles = true;
                            break;
                        case "same-origin-as":
                        ...
                        case "cell-line":
                            ...
                            if (species != null)  {
                                ...
                                if (!conflictResolver.isEmpty()) {
                                    ...
                                    CellLine cellLine = new CellLine(accession, name, Species.get(speciesName) != null ? species.getName() : speciesName);
                ...
                public void consumeText(char[] ch, int start, int length) {
                    if (bAccession) {
            ...
            throw new IOException("Cellosaurus XML parsing failed", e);
        }
