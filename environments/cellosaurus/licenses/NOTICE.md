# Cellosaurus redistribution notices

Reviewed 2026-09-26. This is an independent offline research environment, not an official SIB service or an endorsed product.
...
* Maven 3.9.11 and Tomcat 11.0.11: Apache-2.0. Eclipse Temurin Java 17: GPL-2.0 with Classpath Exception. Container builds retain the distributed Java/Tomcat license material. Browser/runtime dependencies retain their original licenses in the shared images.
* Third-party institutional partner badges are omitted from the distribution UI and replaced with text attribution. No SIB name or logo is used to claim endorsement, publicity approval or business promotion. [Expasy terms](https://www.expasy.org/terms-of-use).
