...
class PUC(CommonInfo):
    ...
    def curated_chemical_count(self):
        ...
        qs = (
            DSSToxLookup.objects.filter(
                curated_chemical__extracted_text__data_document__product__product_uber_puc__puc=self
            )
            .distinct()
            .count()
        )
    ...
    def document_count(self):
        return (
            DataDocument.objects.filter(Q(products__product_uber_puc__puc=self))
            .distinct()
            .count()
        )
