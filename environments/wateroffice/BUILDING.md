# Wateroffice data preparation

Run these tools outside the website containers. Use a separate working directory for source downloads, checks and packaging.
...
Compare the original and local pages in matching content and control states. Wait for table, graph and map loading to finish before taking screenshots. Check map popups, filtering and downloads alongside page layout.
